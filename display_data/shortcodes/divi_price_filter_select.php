...
<div class="divi_price_filter_dropdown_container">
    <select class="divi_price_filter_dropdown">
...
<?php else: ?>
            ...
            <option value="0"><?php _e('Not possible. Enter options ranges in the plugin settings -> tab Structure -> Search by price -> additional options', 'products-filter-custom') ?></option>
